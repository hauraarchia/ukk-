                        ...
                        <form action="upload_fasilitas.php" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_fas" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Kamar">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Keterangan Fasilitas</label>
                                    <textarea name="ket_fas" class="form-control" id="exampleInputPassword1" placeholder="Masukan Info Fasilitas"></textarea>
                                </div>
                                <div class="form-group">
